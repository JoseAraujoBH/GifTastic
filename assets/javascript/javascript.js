$(document).ready(function() {
    ...
    //Array of GIFs
    var gifs = ["United States of America", "Canada", "Mexico", "Brazil"];
    
    //Function of re-rendering HTML to display new GIFs
    function displayDiv(){

        var gif = $(this).attr("data-name");
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gif + "&limit=10&rating=g&api_key=uHhsS3qHH6yIgRWomYTao7OnSZO9K8tJ";
